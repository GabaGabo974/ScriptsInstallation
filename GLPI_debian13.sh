...
EOF
    ...
    if [ "$choix" = "o" ]; then
        ...
        read -p "Entre le nom ou l'adresse IP de l'hôte de l'utilisateur: " host
    ...
    read -p "Entrez l'adresse IP de l'hôte de la base de donnée : " hote
    read -p "Entrez le nom de la base de données: " bdd
