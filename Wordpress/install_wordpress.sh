...
cd ..
sudo -u $(whoami) -i -- wp core install --url="http://$IPV4/wordpress" --title="TestScriptWP" --admin_user="admin" --admin_password="p@ssW0rd" --admin_email="test@machin.com" --path="wordpress"